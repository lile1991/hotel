...
VALUES (1, '标准单间', '', 'NORMAL', 78, 0, now(), 1, now(), 1);
INSERT INTO room_type (id, name, icon, state, charge, deposit, create_time, create_user_id, update_time, update_user_id)
VALUES (2, '豪华单间', '', 'NORMAL', 98, 0, now(), 1, now(), 1);
INSERT INTO room_type (id, name, icon, state, charge, deposit, create_time, create_user_id, update_time, update_user_id)
VALUES (3, '标准双间', '', 'NORMAL', 108, 0, now(), 1, now(), 1);
INSERT INTO room_type (id, name, icon, state, charge, deposit, create_time, create_user_id, update_time, update_user_id)
VALUES (4, '豪华双间', '', 'NORMAL', 128, 0, now(), 1, now(), 1);
