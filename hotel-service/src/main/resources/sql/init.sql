...
VALUES (1, '标准单间', '', 'NORMAL', 7800, 0, now(), 1, now(), 1);
INSERT INTO room_type (id, name, icon, state, charge, deposit, create_time, create_user_id, update_time, update_user_id)
VALUES (2, '豪华单间', '', 'NORMAL', 9800, 0, now(), 1, now(), 1);
INSERT INTO room_type (id, name, icon, state, charge, deposit, create_time, create_user_id, update_time, update_user_id)
VALUES (3, '标准双间', '', 'NORMAL', 10800, 0, now(), 1, now(), 1);
INSERT INTO room_type (id, name, icon, state, charge, deposit, create_time, create_user_id, update_time, update_user_id)
VALUES (4, '豪华双间', '', 'NORMAL', 12800, 0, now(), 1, now(), 1);
